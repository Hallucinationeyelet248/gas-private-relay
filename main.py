#!/usr/bin/env python3
"""
DomainFront Tunnel — Run a local proxy through GAS (Google Apps Script) and a private relay backend.
...
def parse_args():
    parser = argparse.ArgumentParser(
        prog="gas-private-relay",
        description="Local HTTP proxy that relays traffic through Google Apps Script and a private relay backend.",
    )
    parser.add_argument(
        "-c", "--config",
